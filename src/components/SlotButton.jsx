  ...
  return (
    <button
      ...
      className={`relative inline-flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-bold transition-all duration-200 border cursor-pointer active:scale-95 disabled:opacity-40 disabled:cursor-not-allowed ${
        selected
          ? "glossy-gradient-btn text-white shadow-md shadow-emerald-700/30 border-emerald-400/50 scale-[1.02]"
          : available
          ? "bg-white/80 hover:bg-white text-slate-700 hover:text-[#0E7A50] border-slate-200/90 hover:border-emerald-300 hover:shadow-sm"
