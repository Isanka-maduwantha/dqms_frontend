    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-6 text-left">
      <div>
        ...
        <p className="text-xs sm:text-sm text-slate-500 mt-0.5">
          Select your visit date and a clinic period. Your visit purpose will be
          confirmed by reception when you arrive.
        </p>
      </div>
      ...
      <div className="grid lg:grid-cols-12 gap-6 items-start">
          ...
          <Card className="p-5 space-y-4">
            ...
            <div className="space-y-3 text-xs text-slate-600 leading-relaxed">
              <div className="flex gap-3">
                <span className="w-7 h-7 rounded-lg bg-emerald-50 text-[#0E7A50] flex items-center justify-center shrink-0">
                  1
                </span>
                <p>
                  Choose an available date and clinic period and confirm your
                  appointment.
                </p>
              </div>
              <div className="flex gap-3">
                ...
                <p>
                  When you arrive, reception will check you in and ask whether
                  the visit is a new treatment, follow-up consultation, or
              ...
              <div className="flex gap-3">
                ...
                <p>
                  Reception then gives you your live queue token. If the visit
                  is a new treatment, billing is created after the dentist
            ...
            <div className="flex justify-between items-center border-b border-slate-100 pb-3">
              <div>
                <h3 className="font-manrope text-base font-bold text-slate-800">
                  Available Clinic Periods
                </h3>
                <p className="text-xs text-slate-500">
                  {date
                    ? `Showing results for ${formatDate(date)}`
            ...
            {periods.length === 0 ? (
              <div className="py-12 text-center text-slate-500 text-xs">
                ...
                <div className="font-bold text-slate-700 mt-2">
                  No appointment periods available
                </div>
                <p className="mt-1">
                  The clinic may be closed on the selected date.
                </p>
              </div>
            ) : (
                  ...
                  >
                    <div className="flex items-center justify-between gap-4">
                      ...
                      <div className="text-right">
                        <div className="text-lg font-black text-[#0E7A50]">
                          {item.remaining}
                        </div>
                        <div className="text-[10px] uppercase font-bold text-slate-500">
                          of {item.capacity} seats
                        </div>
                      </div>
                    </div>
          ...
          <div className="glass-card p-6 space-y-5 border border-white/80 sticky top-28">
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="flex justify-between gap-3 py-1.5 border-b border-slate-100">
                ...
                <span className="font-bold text-[#0E7A50]">
                  {selectedPeriod?.label || "Not selected"}
                </span>
              </div>
            ...
            <div className="p-3 rounded-xl bg-sky-50 border border-sky-100 text-xs text-sky-900">
              Your appointment number is assigned automatically when you
              confirm. A queue token is assigned by reception when you arrive.
            </div>
        ...
        <PopupBox
          ...
          msg="Are You sure you want to book an appointment?"
          trigger={popup}
          setTrigger={setPopup}
          setConfirm={handleBookAppointment}
        />
      </div>
    </div>
  );
