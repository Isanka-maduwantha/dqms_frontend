  ...
  return (
    <div className="grow min-h-[calc(100vh-5rem)] flex items-center justify-center p-4 sm:p-8">
      <div className="w-full max-w-5xl grid lg:grid-cols-12 rounded-3xl overflow-hidden glass-card border border-white/80 shadow-2xl">
        {/* Left Hero Panel */}
        <div className="lg:col-span-5 bg-gradient-to-br from-blue-700 via-indigo-700 to-slate-900 p-8 sm:p-12 text-white flex flex-col justify-between relative overflow-hidden hidden md:flex">
          <div className="absolute -top-20 -right-20 w-60 h-60 bg-sky-400/20 rounded-full blur-3xl pointer-events-none" />
          <div className="absolute -bottom-20 -left-20 w-60 h-60 bg-blue-500/30 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="relative z-10 space-y-3 pt-8 border-t border-white/15 text-xs text-blue-100">
            <div className="flex items-center gap-3">
              <span className="w-6 h-6 rounded-full bg-sky-400/20 text-sky-300 flex items-center justify-center font-bold">1</span>
              <span>15-minute slot calendar booking</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="w-6 h-6 rounded-full bg-sky-400/20 text-sky-300 flex items-center justify-center font-bold">2</span>
              <span>Real-time lobby queue position</span>
            </div>
            <div className="flex items-center gap-3">
              <span className="w-6 h-6 rounded-full bg-sky-400/20 text-sky-300 flex items-center justify-center font-bold">3</span>
